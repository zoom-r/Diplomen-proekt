...
function testUpdateUser() {
  ...
  test('Test updateUser_ function - successful update', function(t) {
    ...
    const user = new User('1', 'Test User', 'test@example.com', '1234567890', 'admin', 'manager', timetable, 'workspace_id', 'declarations_key', 'notifications_key');
            ...
            executeQuery: function() {
              return {
                ...
                getString: function(column) {
                  if (column === 'notifications_key') return 'notifications_key';
                  if (column === 'declarations_key') return 'declarations_key';
                  return null;
                }
              };
            },
          ...
          return {
            ...
            executeQuery: function() {
              return {
                next: function() { return true; },
                getString: function(column) {
                  if (column === 'id') return 'workspace_id';
                  return null;
                }
              };
            },
